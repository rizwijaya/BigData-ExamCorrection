...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url();?>templateHome/assets/images/favicon.svg" />
    ...
    <!-- ========================= CSS here ========================= -->
    <link rel="stylesheet" href="<?= base_url();?>templateHome/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?= base_url();?>templateHome/assets/css/LineIcons.2.0.css" />
    <link rel="stylesheet" href="<?= base_url();?>templateHome/assets/css/animate.css" />
    <link rel="stylesheet" href="<?= base_url();?>templateHome/assets/css/tiny-slider.css" />
    <link rel="stylesheet" href="<?= base_url();?>templateHome/assets/css/glightbox.min.css" />
    <link rel="stylesheet" href="<?= base_url();?>templateHome/assets/css/main.css" />
...
<body>
                    ...
                    <div class="nav-inner">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="<?= base_url();?>templateHome/assets/images/logo/logo.svg" alt="Logo">
                            </a>
                    ...
                    <div class="col-12 p-0">
                        <div class="category-slider">
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/car.svg" alt="#">
                                </div>
                                <h3>Vehicle</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/laptop.svg" alt="#">
                                </div>
                                <h3>Electronics</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/matrimony.svg" alt="#">
                                </div>
                                <h3>Matrimony</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/furniture.svg" alt="#">
                                </div>
                                <h3>Furnitures</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/jobs.svg" alt="#">
                                </div>
                                <h3>Jobs</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/real-estate.svg" alt="#">
                                </div>
                                <h3>Real Estate</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/hospital.svg" alt="#">
                                </div>
                                <h3>Health & Beauty</h3>
                                <h5 class="total">22</h5>
                            </a>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/tshirt.svg" alt="#">
                                </div>
                                <h3>Fashion</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/education.svg" alt="#">
                                </div>
                                <h3>Education</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/controller.svg" alt="#">
                                </div>
                                <h3>Gadgets</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/travel.svg" alt="#">
                                </div>
                                <h3>Backpacks</h3>
                            ...
                            <a href="category.html" class="single-cat">
                                <div class="icon">
                                    <img src="<?= base_url();?>templateHome/assets/images/categories/watch.svg" alt="#">
                                </div>
                                <h3>Watches</h3>
                                <h5 class="total">65</h5>
                            </a>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".2s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail"><img src="<?= base_url();?>templateHome/assets/images/items-grid/img1.jpg" alt="#"></a>
                                <div class="author">
                                    <div class="author-image">
                                        <a href="javascript:void(0)"><img src="<?= base_url();?>templateHome/assets/images/items-grid/author-1.jpg" alt="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail"><img src="<?= base_url();?>templateHome/assets/images/items-grid/img2.jpg" alt="#"></a>
                                <div class="author">
                                    <div class="author-image">
                                        <a href="javascript:void(0)"><img src="<?= base_url();?>templateHome/assets/images/items-grid/author-2.jpg" alt="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".6s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail"><img src="<?= base_url();?>templateHome/assets/images/items-grid/img3.jpg" alt="#"></a>
                                <div class="author">
                                    <div class="author-image">
                                        <a href="javascript:void(0)"><img src="<?= base_url();?>templateHome/assets/images/items-grid/author-3.jpg" alt="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".2s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail"><img src="<?= base_url();?>templateHome/assets/images/items-grid/img4.jpg" alt="#"></a>
                                <div class="author">
                                    <div class="author-image">
                                        <a href="javascript:void(0)"><img src="<?= base_url();?>templateHome/assets/images/items-grid/author-4.jpg" alt="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail"><img src="<?= base_url();?>templateHome/assets/images/items-grid/img5.jpg" alt="#"></a>
                                <div class="author">
                                    <div class="author-image">
                                        <a href="javascript:void(0)"><img src="<?= base_url();?>templateHome/assets/images/items-grid/author-5.jpg" alt="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".6s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail"><img src="<?= base_url();?>templateHome/assets/images/items-grid/img6.jpg" alt="#"></a>
                                <div class="author">
                                    <div class="author-image">
                                        <a href="javascript:void(0)"><img src="<?= base_url();?>templateHome/assets/images/items-grid/author-6.jpg" alt="#">
    ...
    <!-- ========================= JS here ========================= -->
    <script src="<?= base_url();?>templateHome/assets/js/bootstrap.min.js"></script>
    <script src="<?= base_url();?>templateHome/assets/js/wow.min.js"></script>
    <script src="<?= base_url();?>templateHome/assets/js/tiny-slider.js"></script>
    <script src="<?= base_url();?>templateHome/assets/js/glightbox.min.js"></script>
    <script src="<?= base_url();?>templateHome/assets/js/main.js"></script>
